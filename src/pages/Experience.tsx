    ...
    <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
      <section className="relative mb-10 overflow-hidden rounded-[2rem] soft-panel px-6 py-8 sm:px-8 sm:py-10">
        ...
        <SectionHeader
          ...
          description="Registro cronológico de roles profesionales y académicos, generado dinámicamente desde los datos."
          className="mb-0"
        />
      </section>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <aside className="space-y-4 lg:sticky lg:top-24 lg:self-start">
          ...
          <div className="soft-panel rounded-[1.5rem] p-5">
            <h3 className="text-sm font-semibold text-foreground">Áreas cubiertas</h3>
            <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
              <li className="flex items-center gap-2">
                <span className="h-1.5 w-1.5 rounded-full bg-accent" /> Docencia y mentoría
              </li>
              <li className="flex items-center gap-2">
                <span className="h-1.5 w-1.5 rounded-full bg-accent" /> Operaciones de datos y control de calidad
              </li>
              <li className="flex items-center gap-2">
                <span className="h-1.5 w-1.5 rounded-full bg-accent" /> Desarrollo web
              </li>
            </ul>
          </div>
        </aside>
